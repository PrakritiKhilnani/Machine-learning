# In this code I have implemented Logistic Regression using Mini Batch without Feature scaling.
import numpy as np
import pandas as pd
...
# Finding parameters by Mini Batch GDA
# Learning rate=0.01 , epochs=50000
w=mini_batch_gradient_descent(train_x,train_y,25,0.0001)
# Finding accuracy
